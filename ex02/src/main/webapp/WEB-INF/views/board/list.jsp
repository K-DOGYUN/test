                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Board List Page
                            <button type="button" id='regBtn' class="btn btn-xs btn-outline btn-default pull-right">Register New Board</button>
                        </div>
                        <!-- /.panel-heading -->
                            	...
                            	<div class="col-lg-12">
                            		<form id="searchForm" action="/board/list" method="get">
                            			<select name="type">
                            				...
                            				<option value="WC" <c:out value="${pageMaker.cri.type eq 'WC'?'selected':''}"/>>
                            					내용 또는 작성자
                            				</option>
...
<script>
	$(document).ready(function(){
		...
		$(".previous a").on("click", function(e) {
			e.preventDefault();
			var prev = Number(actionForm.find("input[name='pageNum']").val())-5
			actionForm.find("input[name='pageNum']").val(prev);
			actionForm.attr("action","/board/list")
			actionForm.submit();
		});
		$(".next a").on("click", function(e) {
			e.preventDefault();
			var nex = Number(actionForm.find("input[name='pageNum']").val())+4;
			console.log(nex);
			actionForm.find("input[name='pageNum']").val(nex);
			actionForm.attr("action","/board/list")
			actionForm.submit();
		});
